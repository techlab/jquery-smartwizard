...
(function (factory) {
    ...
    var defaults = {
        ...
        toolbarSettings: {
            ...
            customClassNextButton: '', // Custom class for Next button
            customClassPreviousButton: ''// Custom class for Previous button
        },
        anchorSettings: {
    ...
    class SmartWizard {
        ...
        _createToolbar(position) {
            ...
            let btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass(this.options.toolbarSettings.customClassNextButton || 'toolbar-btn').addClass('sw-btn-next').attr('type', 'button') : null;
            let btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.previous).addClass(this.options.toolbarSettings.customClassPreviousButton || 'toolbar-btn').addClass('sw-btn-prev').attr('type', 'button') : null;
